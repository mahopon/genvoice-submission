      ...
      {!isAuthenticated ?
        (
          <>
            ...
            <div>
              <h2>Links</h2>
              <a href="https://github.com/mahopon" target="_blank" rel="noopener noreferrer">
                <img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt="GitHub" width="32" height="32" />
              </a>&nbsp;&nbsp;
              <a href="https://www.linkedin.com/in/chong-yao-tan-22bb021a6/" target="_blank" rel="noopener noreferrer">
